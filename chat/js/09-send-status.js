  ...
  try {
    ...
    if (err.name === 'AbortError') {
      if (full) {
        ...
        chargeCreditForExchange(text, full);
      } else {
...
updateLimitBannerUI();
renderCreditBadge();
// Jaga-jaga race condition: kalau event login Supabase sempet nembak sebelum baris ini ke-load,
// proses ulang sekali di sini (sbDispatchAuthEvent aman dipanggil berkali-kali).
if (sbLastAuthEvent !== null) sbDispatchAuthEvent(sbLastAuthEvent, sbLastAuthSession);
