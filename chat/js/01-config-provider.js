...
const LS_REMEMBERED_EMAIL = 'oxychat_remembered_email_v1';
...
const PLANS = {
  gratis: { label: 'Newbie', keyLimit: '1x', msgLimit: '10', harga: 'FREE' },
  pro:    { label: 'Pro', keyLimit: '1x', msgLimit: '100', harga: '20K' },
  maks:   { label: 'Max', keyLimit: '1x', msgLimit: '300', harga: '30K' },
  promax: { label: 'Pro Max', keyLimit: '1x', msgLimit: '450', harga: '50K' }
};
