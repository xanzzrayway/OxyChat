...
// Fix: pas AI lagi ngetik (streaming), forceScrollBottom() dipanggil berkali-kali per detik.
// Event 'scroll' baru nyala SETELAH browser gerak, jadi ada jeda dikit — dalam jeda itu
// auto-scroll masih nganggep user belum geser, jadi tetep narik balik ke bawah dan
// "ngelawan" jari user yang lagi coba scroll ke atas. Solusinya: tandain niat user
// LANGSUNG pas dia mulai sentuh/scroll/drag, sebelum event 'scroll' sempet nyusul.
['touchstart', 'wheel', 'pointerdown'].forEach(evt => {
  $msgs.addEventListener(evt, () => { userScrolledUp = true; }, { passive: true });
});
