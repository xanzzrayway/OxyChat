...
function saveSessions() {
  try {
    ...
    // Sinkron sesi yang lagi aktif ke Supabase (di-debounce di dalam fungsinya) kalau lagi login
    if (typeof sbSession !== 'undefined' && sbSession && activeId && toSave[activeId]) {
      sbQueueSaveConversation(activeId, toSave[activeId]);
    }
  } catch(e) {}
}
